...
extension NSColor {
    ...
    static let highlightBackground = NSColor(named: NSColor.Name("highlightBackground"))!
    static let primaryTextInvert = NSColor(named: NSColor.Name("primaryTextInvert"))!
